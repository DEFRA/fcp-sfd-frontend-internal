 ...
 *
 * The first step is to take the number of records and divide them by our page size config (defaults to 20) to determine
 * how many pages are needed. If only 1 page is required (`numberOfRecords` is less then or equal to 20) no pagination
 ...
 */
const paginationPresenter = (numberOfRecords, page, path, numberOfShownItems, message, queryArgs) => {
  // message = 'businesses'
